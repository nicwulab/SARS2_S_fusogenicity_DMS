...
coloring <- function(mut){
  if (mut %in% c("K986P", "V987P", "A892P", "A899P", "A942P")){return ("HexaPro")}
  else if (mut %in% c("D994E", "D994Q", "T961F", "Q1005R")){return ("This study 1")}
  else if (mut %in% c("S943H","A944S")){return ("This study 2")}
  else if (mut %in% c("WT")){return ("WT")}
  else if (mut %in% c("D950N", "Q954H", "N969K", "L981F", "S982A", "T1027I")){return ("This study 3")}
  else {return ('others')}
  }

##### MAIN #####
group_level <- c('HexaPro','This study 1', 'This study 2', 'This study 3')
...
print (paste("correlatoin between fusion score and expression score: ", cor(df$exp_score, df$fus_score)))
