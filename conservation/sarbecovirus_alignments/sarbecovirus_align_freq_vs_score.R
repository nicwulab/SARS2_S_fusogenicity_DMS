...
frequency_data <- read.csv(file = 'sarbecovirus_S_S2_sequence_conservation.csv', header = TRUE)
...
plot_freq_vs_score(frequency_data,"dms_expression_vs_seq_conservation_sarbecovirus.pdf", "exp")
plot_freq_vs_score(frequency_data,"dms_fusion_vs_seq_conservation_sarbecovirus.pdf", "fus")
