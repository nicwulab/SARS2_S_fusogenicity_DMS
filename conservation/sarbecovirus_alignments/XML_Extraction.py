...
def parse_ncbi_xml_to_csv(infile, outfile, query, delim = ','):
    ...
    for line in open(infile).readlines():
        if r_query_id.search(line) is not None:
            ...
            var_list = [query_id, hit_id, percent_ident, hsp_align_len, mismatch, hsp_gaps, hsp_query_from, hsp_query_to, hsp_hit_from, hsp_hit_to, hsp_evalue, hsp_bit_score, hit_def, hsp_hseq]
