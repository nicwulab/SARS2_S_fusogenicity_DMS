...
df <- read.csv(file = 'expr.csv', header = TRUE)
...
ggsave("expr_pre.pdf", width = 10, height = 8, plot = pre)
ggsave("expr_post.pdf", width = 5, height = 8, plot = post)
ggsave("expr_combo.pdf", width = 8, height = 8, plot = combo)